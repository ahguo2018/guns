...
//                            + (long) (Math.random() * 10000000L);
        ...
        String body = "购买电影票花费" + totalAmount + "元";

        // 商户操作员编号，添加此参数可以为商户操作员做销售统计
        String operatorId = "gcc";
...
//        goodsDetailList.add(goods2);
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                filePath = String.format("C:/Users/GCC/Desktop/qrcode/qr-%s.png",
...
//                }
                //支付成功修改订单支付状态
                payFlag = orderServiceAPI.paySuccess(orderId);
                break;
